...
- Prebuilt Container Image: [ghcr.io/clamsproject/app-tesseractocr-wrapper:v2.1](https://github.com/clamsproject/app-tesseractocr-wrapper/pkgs/container/app-tesseractocr-wrapper/v2.1)<button class="copy-btn" data-clip="ghcr.io/clamsproject/app-tesseractocr-wrapper:v2.1" title="Copy image tag" aria-label="Copy image tag">&#128203;</button>
- Release Notes
