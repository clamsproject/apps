...
- Prebuilt Container Image: [ghcr.io/clamsproject/app-whisper-wrapper:v12](https://github.com/clamsproject/app-whisper-wrapper/pkgs/container/app-whisper-wrapper/v12)<button class="copy-btn" data-clip="ghcr.io/clamsproject/app-whisper-wrapper:v12" title="Copy image tag" aria-label="Copy image tag">&#128203;</button>
- Release Notes
...
- Source Repository: [https://github.com/clamsproject/app-whisper-wrapper](https://github.com/clamsproject/app-whisper-wrapper) ([source tree of the submitted version](https://github.com/clamsproject/app-whisper-wrapper/tree/v12)<button class="copy-btn" data-clip="https://github.com/clamsproject/app-whisper-wrapper/tree/v12" title="Copy source URL" aria-label="Copy source URL">&#128203;</button>)
