...
- Prebuilt Container Image: [ghcr.io/clamsproject/app-swt-detection:v4.0](https://github.com/clamsproject/app-swt-detection/pkgs/container/app-swt-detection/v4.0)<button class="copy-btn" data-clip="ghcr.io/clamsproject/app-swt-detection:v4.0" title="Copy image tag" aria-label="Copy image tag">&#128203;</button>
- Release Notes
